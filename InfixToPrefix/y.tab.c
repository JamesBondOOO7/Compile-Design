...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OPR1 = 5,                       /* OPR1  */
  YYSYMBOL_OPR2 = 6,                       /* OPR2  */
...
static const char *const yytname[] =
{
  ...
  "IDENTIFIER", "OPR1", "OPR2", "NEWLINE", "EXIT", "'('", "')'", "$accept",
  "lines", "exp", YY_NULLPTR
};
...
{
       2,     3,     4,     3,     4,    10,     5,     6,     5,     6,
       9,    10,     0,     8,     0,    12,    13,    14,     9,    10,
      11
};
...
#line 47 "yacc.y"
                  { (yyval.exp) = concat((yyvsp[-1].exp),(yyvsp[-2].exp),(yyvsp[0].exp)); }
#line 1172 "y.tab.c"
    break;
